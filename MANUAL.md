# Manual Setup Steps for Minions Clients
...
Go to **GitHub → mxn2020/minions-clients → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-clients` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-clients-web`
- **GitHub repo**: `mxn2020/minions-clients`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `clients.minions.wtf`

### Documentation
- **Netlify site name**: `minions-clients-docs`
- **GitHub repo**: `mxn2020/minions-clients`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `clients.minions.help`

### Blog
- **Netlify site name**: `minions-clients-blog`
- **GitHub repo**: `mxn2020/minions-clients`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `clients.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `clients.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `clients.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `clients.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-clients/sdk`](https://www.npmjs.com/package/@minions-clients/sdk)
- CLI: [`@minions-clients/cli`](https://www.npmjs.com/package/@minions-clients/cli)
...
Your package: [`minions-clients`](https://pypi.org/project/minions-clients/)
...
| Item | Value |
|------|-------|
| Project | `minions-clients` |
| SDK (npm) | `@minions-clients/sdk` |
| CLI (npm) | `@minions-clients/cli` |
| Python (PyPI) | `minions-clients` |
| GitHub | `github.com/mxn2020/minions-clients` |
| Docs domain | `clients.minions.help` |
| Blog domain | `clients.minions.blog` |
| App domain | `clients.minions.wtf` |
