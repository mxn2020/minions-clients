...
/**
 * @minions-clients/cli — CLI for Minions clients
 *
...
import { customTypes } from '@minions-clients/sdk';
...
program.name('clients').description('Client profiles built from job interactions, communications, and contracts').version('0.1.0');

program.command('info').description('Show project info').action(() => {
    console.log(chalk.bold('Minions clients'));
    console.log(chalk.dim('Client profiles built from job interactions, communications, and contracts'));
    console.log('');
    console.log(`  SDK:    ${chalk.cyan('@minions-clients/sdk')}`);
    console.log(`  CLI:    ${chalk.cyan('@minions-clients/cli')}`);
    console.log(`  Python: ${chalk.cyan('minions_clients')}`);
